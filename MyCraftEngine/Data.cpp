...
std::vector<Recipe> loadRecipes() {
    ...
    r.push_back(Recipe("Dagger",
            { iron, wood },
            "Forge Hammer",1));
    r.push_back(Recipe("Knife",
            { iron1, steel },
            "Forge Hammer",1));
    r.push_back(Recipe("Javelin",
            { wood2, iron },
            "Forge Hammer",1));
    r.push_back(Recipe("Vampire Mallet",
            {wood,fang,dark},
            "Forge Hammer",1));
    r.push_back(Recipe("Mystery Codex",
            { dust, cloth },
            "Mystical Arcane Table",1));
    r.push_back(
        Recipe(
            "Book of Sages",
            {
            ...
            "Mystical Arcane Table",1));
    r.push_back(Recipe("Magic Necklace",
            {  mana, shard },
            "Mystical Arcane Table",1));
    r.push_back(Recipe("Vitality Crystal",
            { shard2, energy },
            "Guardian Sigil",1));
    r.push_back(Recipe("Leather Jerkin",
            { leather, cloth },
            "Guardian Sigil",1));
    r.push_back(Recipe("Magic Resist Cloak",
            { cloth2, mana },
            "Guardian Sigil",1));


    r.push_back(Recipe("Silence Robe",
            {
                Ingredient("Vitality Crystal", 1, "pcs"),
                Ingredient("Magic Resist Cloak", 1, "pcs")
            },
            "Guardian Sigil",2));
    r.push_back(Recipe("Steel Legplates",
            {
                Ingredient("Leather Jerkin", 1, "pcs")
            },
            "Guardian Sigil",2));
    r.push_back(Recipe("Ares Belt",
            {
                Ingredient("Vitality Crystal", 1, "pcs")
            },
            "Guardian Sigil",2));
    r.push_back(Recipe("Magic Wand",
            {
                Ingredient("Mystery Codex", 1, "pcs")
            },
            "Mystical Arcane Table",2));
    r.push_back(Recipe("Exotic Veil",
            {
                Ingredient("Mystery Codex", 1, "pcs")
            },
            "Mystical Arcane Table",2));
    r.push_back(Recipe("Tome of Evil",
            {
                Ingredient("Magic Necklace", 1, "pcs"),
                Ingredient("Book of Sages", 1, "pcs")
            },
            "Mystical Arcane Table",2));
    r.push_back(Recipe("Azure Blade",
            {
                Ingredient("Magic Necklace", 2, "pcs")
            },
            "Forge Hammer",2));
    r.push_back(Recipe("Legion Sword",
            {
                Ingredient("Dagger", 2, "pcs")
            },
            "Forge Hammer",2));
    r.push_back(Recipe("Regular Spear",
            {
                Ingredient("Knife", 1, "pcs"),
                Ingredient("Dagger", 1, "pcs")
            },
            "Forge Hammer",2));
    r.push_back(Recipe("Rogue Meteor",
            {
                Ingredient("Knife", 1, "pcs"),
                Ingredient("Javelin", 1, "pcs")
            },
            "Forge Hammer",2));
    r.push_back(Recipe("Athena's Shield",{
            Ingredient("Silence Robe", 1, "pcs"),
            Ingredient("Vitality Crystal", 1, "pcs")
            },
            "Guardian Sigil",3));
    r.push_back(Recipe("Chastise Pauldron",
            {
                Ingredient("Steel Legplates", 1, "pcs"),
                Ingredient("Ares Belt", 1, "pcs")
            },
            "Guardian Sigil",3));
    r.push_back(Recipe("Blade Armor",
            {
                Ingredient("Steel Legplates", 1, "pcs"),
                Ingredient("Leather Jerkin", 2, "pcs")
            },
            "Guardian Sigil",3));
    r.push_back(Recipe("Blood Wings",
            {
                Ingredient("Magic Wand", 2, "pcs")
            },
            "Mystical Arcane Table",3));
    r.push_back(Recipe("Genius Wand",
            {
                Ingredient("Exotic Veil", 1, "pcs"),
                Ingredient("Magic Wand", 1, "pcs")
            },
            "Mystical Arcane Table",3));
    r.push_back(Recipe("Glowing Wand",
            {
                Ingredient("Exotic Veil", 1, "pcs"),
                Ingredient("Mystery Codex", 1, "pcs"),
                Ingredient("Vitality Crystal", 1, "pcs")
            ...
            "Mystical Arcane Table",3));
    r.push_back(Recipe("Enchanted Talisman",
            {
            ...
            "Mystical Arcane Table",3));
    r.push_back(Recipe("Starlium Scythe",
            {
    ...
    r.push_back(Recipe("Blade of Despair",
            {
                Ingredient("Legion Sword", 2, "pcs")
            },
            "Forge Hammer",3));
    r.push_back(Recipe("Sea Healberd",
            {
                Ingredient("Legion Sword", 1, "pcs"),
                Ingredient("Regular Spear", 1, "pcs")
            },
            "Forge Hammer",3));
    r.push_back(Recipe("Demon Hunter Sword",
            {
                Ingredient("Regular Spear", 1, "pcs"),
            ...
            "Forge Hammer",3));
    r.push_back(Recipe("Berserker's Fury",
            {
                Ingredient("Legion Sword", 1, "pcs"),
                Ingredient("Javelin", 2, "pcs")
            },
            "Forge Hammer",3));
    r.push_back(Recipe("Haas' Claw",
            {
                Ingredient("Vampire Mallet", 1, "pcs"),
            ...
            "Forge Hammer",3));
    r.push_back(Recipe("Tool Ascension",
            {
